...
- <a name="requirement_azapi"></a> [azapi](#requirement\_azapi) (>= 1.12.0, < 2.0)

- <a name="requirement_azurerm"></a> [azurerm](#requirement\_azurerm) (>= 3.90.0, < 4.0)
...
- <a name="provider_azapi"></a> [azapi](#provider\_azapi) (>= 1.12.0, < 2.0)

- <a name="provider_azurerm"></a> [azurerm](#provider\_azurerm) (>= 3.90.0, < 4.0)
